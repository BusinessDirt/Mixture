...
ifeq ($(config),debug)
TARGETDIR = ../../../bin/Debug-macosx-x86_64/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../../../bin-int/Debug-macosx-x86_64/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -fPIC -g -w
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -fPIC -g -w

else ifeq ($(config),release)
TARGETDIR = ../../../bin/Release-macosx-x86_64/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../../../bin-int/Release-macosx-x86_64/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -O3 -fPIC -w
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -O3 -fPIC -w

else ifeq ($(config),dist)
TARGETDIR = ../../../bin/Dist-macosx-x86_64/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../../../bin-int/Dist-macosx-x86_64/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -O3 -fPIC -w
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -arch x86_64 -O3 -fPIC -w
