...
namespace Mixture::Vulkan 
{
    ...
    Image::Image(const VkExtent2D extent, const VkFormat format)
        : Image(extent, format, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT)
    {
    }

    Image::Image(const VkExtent2D extent, const VkFormat format, const VkImageTiling tiling, const VkImageUsageFlags usage)
        : m_Extent(extent), m_Format(format), m_ImageLayout(VK_IMAGE_LAYOUT_UNDEFINED)
    {
